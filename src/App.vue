    ...
    <div class="wrapper-content">
      ...
      <section>
        <div class="container">
          ...
          <button class="btn btnPrimary" @click="modalValidate = !modalValidate">Show second modal + modalValidate</button>
          <modalValidate :modalValidate="modalValidate" v-show="modalValidate" @close="modalValidate = false" />
        </div>
      </section>
